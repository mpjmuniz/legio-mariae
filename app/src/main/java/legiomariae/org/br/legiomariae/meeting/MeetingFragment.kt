...
class MeetingFragment : Fragment() {
    ...
    private class PageAdapter(fm: FragmentManager?, c : Context) : FragmentPagerAdapter(fm) {
        ...
        * TODO: c.getString(R.string.title_al),
                ...
                Callings depends on 3
                Treasurer Report for all depends on nothing, but only for treasurer depends on 3
                Works Report for all depends on nothing
                Allocutio timer depends on nothing
                Timer for Catena
        * */
        ...
        private val titles = listOf(c.getString(R.string.get_started),
                c.getString(R.string.title_ip), c.getString(R.string.title_pi),
        ...
        pager.addOnPageChangeListener(object : ViewPager.SimpleOnPageChangeListener(){
            override fun onPageSelected(position: Int) {
                ...
                if(!started){
                    ...
                    Handler().postDelayed(changeToCatena, 10000)
                } else {
                    if(position == 0) {
                        started = false
                    }
